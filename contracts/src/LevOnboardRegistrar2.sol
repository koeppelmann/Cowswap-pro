...
contract LevOnboardRegistrar2 {
    // --- the committed intent (template) ---
    address public constant OWNER     = 0xCA1fb23ec08227177e419807d52BbefFD34A19ee; // user EOA
    uint256 public constant EQUITY    = 0.01e18;            // pulled from OWNER at fill
    uint256 public constant FLASH     = 0.02e18;             // flash-borrowed + sold (2x)
    uint256 public constant BUY_MIN   = 9676077638277;      // min WETH out (20% slippage)
    uint256 public constant BORROW    = 10010000000000000;   // FLASH*1.0005 - EQUITY
    uint256 public constant REPAY     = 20010000000000000;   // FLASH*1.0005
    uint32  public constant EXPIRY    = 1781700000;          // template dead after this
